...
export const CHANGELOG: ChangelogEntry[] = [
  {
    version: "8.7.26",
    date: "2026-09-26",
    title: "音质升级 · 歌词高亮根修 · 封面频谱律动",
    channel: "shell",
    highlights: [
      "播放器新增音质升级：标准 / 极高 / 无损（黑胶）三档轮换，播放中切档进度不丢，按账号权限自动回退并提示",
      "修复当前播放句没有高亮扫色的问题（逐字时间轴错位根修，翻译与逐行高亮同步校准）",
      "网易云播放器封面新增频谱高光律动，与音乐面板「律动」开关同通道",
      "修复磁贴等按钮悬停时出现位移动画的问题，恢复纯放大手感",
    ],
  },
  {
    version: "8.7.25",
  ...
  },
  {
    ...
    channel: "shell",
    highlights: [
      "点击封面打开歌词页（原「词」钮职责移交），词钮改为全局歌词浮层开关，与音乐面板同通道",
      "歌词页动效对标音乐面板：呼吸缩放 + 高斯景深 + 已唱渐隐 + 翻译行平滑展开，背景加实提升可读性",
      "播放器歌词接入全局歌词浮层与悬浮浮窗：内置播放器一开声，所有网页立即跟随显示与歌词",
      "网页浮窗可直接控制内置播放器（播放/暂停/切歌/拖进度），外部网易云暂停时自动让位、恢复时接管",
      "音量改为滑块无极调节（拖拽即改、自动记忆），喇叭图标保留一键静音",
      "播放页新增退出登录：点头像栏账号徽标两步确认即退，扫码重登不受影响",
    ],
  },
  {
    version: "8.7.23",
