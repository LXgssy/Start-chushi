...
/* shot-v200.mjs — v2.0.0 视觉验收：双主题音乐面板（播放+逐字歌词）+ 切换中帧（模糊散场） */
...
mkdirSync("/home/z/my-project/scripts/pw-lab/shots/v200", { recursive: true });
const OUT = "/home/z/my-project/scripts/pw-lab/shots/v200";
