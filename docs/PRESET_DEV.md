...
| `widgets` | 数组 ≤3 | 小部件：角落磁贴 / dock 按钮+弹出面板（surface，见 §12），单块 html ≤30400 字符（v1.9.0 起 12000→18000，v8.2.9 起 18000→26400，v8.7.12 起 26400→27600，v8.7.18 起 27600→28800，v8.7.23 起 28800→30400 逐步放宽） |
