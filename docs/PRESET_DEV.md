...
| `widgets` | 数组 ≤3 | 小部件：角落磁贴 / dock 按钮+弹出面板（surface，见 §12），单块 html ≤39600 字符（v1.9.0 起 12000→18000，v8.2.9 起 18000→26400，v8.7.12 起 26400→27600，v8.7.18 起 27600→28800，v8.7.23 起 28800→30400，v8.7.24 起 30400→36800，v8.7.26 起 36800→39600 逐步放宽） |
...
| `height` | 初始高度 40–460 px（缺省 88；dock 表面即弹出面板初始高度，后续随 `chushi.resize` 弹簧跟随；v1.9.0 起上限 460） |
